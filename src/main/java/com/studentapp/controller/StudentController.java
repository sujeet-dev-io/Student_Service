...
//	}
    ...
    public ResponseEntity<BaseResponse<Object>> deleteDetails(@PathVariable Integer id) {
        BaseResponse<Object> response = BaseResponse.builder()
                ...
                .data(studentService.SoftDeleteDetails(id)).build();
    ...
    public ResponseEntity<BaseResponse<Object>> HardDeleteDetails(@PathVariable Integer id) {
        BaseResponse<Object> response = BaseResponse.builder()
                .successMsg("Student Deleted")
                .data(studentService.HardDeleteDetails(id)).build();
